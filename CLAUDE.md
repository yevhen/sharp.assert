...
## Overview
SharpAssert uses PowerAssert as both an optional backend and automatic fallback for unsupported features. This enables immediate package release while continuing development.

## Configuration
- **UsePowerAssert** - Force PowerAssert for ALL assertions (default: false)
- **UsePowerAssertForUnsupportedFeatures** - Auto-fallback to PowerAssert for unimplemented features (default: true)

## Implementation Stages

### Stage 1: Immediate Release (Current)
...
As each feature is implemented, it automatically switches from PowerAssert to SharpAssert:
...
6. Async and dynamic (Increments 10-12)
...
## Testing Strategy
- Default mode: `dotnet test SharpAssert.Tests/`
- PowerAssert mode: `dotnet test SharpAssert.PowerAssertTest/`
- Full validation: `./test-local.sh`
